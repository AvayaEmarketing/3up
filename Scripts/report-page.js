    ...
    if (result.d != "[]") {
        ...
        if (dataTab != "error") {
            ...
            oTable = $('#datatables').dataTable({
                "bProcessing": true,
                "aaData": dataTab,
                "aoColumns": [{ "mDataProp": "id" }, { "mDataProp": "Nombre" }, { "mDataProp": "Puesto" }, { "mDataProp": "Empresa" }, { "mDataProp": "Email" }, { "mDataProp": "Telefono" }, { "mDataProp": "Extension" }, { "mDataProp": "q1" }, { "mDataProp": "q2" }],
...
function exportarTabla(formato) {
    var DTO = { 'format': formato, 'tipo_usuario': "partner" };
